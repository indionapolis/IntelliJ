 ...
 * v1.1
 */
public class BTree<K extends Comparable<K>, V>  implements BT {

    //properties of tree
    private int height;
    private int order;    //set up in main class
    private int size;
    ...
    private V find(Node node, Comparable key, int lvl) {
    ...
    private Node insert(Node node, Comparable key, Object value, int lvl) {
        int i;
